      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="plan-card">
          ...
          <div class="plan-card-actions">
            <a href="https://vincu.com/co/empresas/precios" class="btn btn-vincu btn-bolder btn-success btn-lg">Más Información</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="plan-card">
          ...
          <div class="plan-card-actions">
            <a href="https://vincu.com/co/empresas/precios" class="btn btn-vincu btn-bolder btn-success btn-lg">Ver más</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-12">
